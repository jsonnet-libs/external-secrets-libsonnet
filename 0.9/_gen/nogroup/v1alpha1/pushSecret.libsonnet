{
  ...
  spec: {
    ...
    data: {
      ...
      '#withMetadata':: d.fn(help='"Metadata is metadata attached to the secret. The structure of metadata is provider specific, please look it up in the provider documentation."', args=[d.arg(name='metadata', type=d.T.any)]),
