{
  ...
  spec: {
    ...
    selector: {
      ...
      secret: {
        '#withName':: d.fn(help='"Name of the Secret. The Secret must exist in the same namespace as the PushSecret manifest."', args=[d.arg(name='name', type=d.T.string)]),
    ...
    '#withDeletionPolicy':: d.fn(help='"Deletion Policy to handle Secrets in the provider. Possible Values: \\"Delete/None\\". Defaults to \\"None\\"."', args=[d.arg(name='deletionPolicy', type=d.T.string)]),
