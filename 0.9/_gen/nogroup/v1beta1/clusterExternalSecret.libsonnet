{
  ...
  spec: {
    ...
    '#withNamespaces':: d.fn(help='"Choose namespaces by name. This field is ORed with anything that NamespaceSelector ends up choosing."', args=[d.arg(name='namespaces', type=d.T.array)]),
    withNamespaces(namespaces): { spec+: { namespaces: if std.isArray(v=namespaces) then namespaces else [namespaces] } },
    '#withNamespacesMixin':: d.fn(help='"Choose namespaces by name. This field is ORed with anything that NamespaceSelector ends up choosing."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='namespaces', type=d.T.array)]),
