{
  ...
  '#new':: d.fn(help='new returns an instance of Password', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
    apiVersion: 'generators.external-secrets.io/v1alpha1',
    kind: 'Password',
  } + self.metadata.withName(name=name),
  '#spec':: d.obj(help='"PasswordSpec controls the behavior of the password generator."'),
  spec: {
    ...
    withSecretKeys(secretKeys): { spec+: { secretKeys: if std.isArray(v=secretKeys) then secretKeys else [secretKeys] } },
    ...
    withSecretKeysMixin(secretKeys): { spec+: { secretKeys+: if std.isArray(v=secretKeys) then secretKeys else [secretKeys] } },
